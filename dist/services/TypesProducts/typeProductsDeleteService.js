...
// src/services/TypesProducts/typeProductsDeleteService.ts
var typeProductsDeleteService_exports = {};
__export(typeProductsDeleteService_exports, {
  TypeProductsDeleteService: () => TypeProductsDeleteService
});
module.exports = __toCommonJS(typeProductsDeleteService_exports);
...
// src/services/TypesProducts/typeProductsDeleteService.ts
var TypeProductsDeleteService = class {
  execute(_0) {
    return __async(this, arguments, function* ({ id, idUserOwner }) {
      if (!id) {
        return {
          data: {
            message: "N\xE3o foi poss\xEDvel prosseguir com esta a\xE7\xE3o, por favor envio o id do tipo do produto para prosseguir",
            status: 403
          }
        };
      }
      ...
      const typeProductExists = yield prisma_default.typesProducts.findFirst({
        where: {
          id
        }
      });
      if (!typeProductExists) {
        return {
          data: {
            message: "N\xE3o foi poss\xEDvel prosseguir com esta a\xE7\xE3o, este tipo do produto n\xE3o existe",
            status: 403
          }
        };
      }
      ...
      try {
        ...
        const responseDelete = yield binRegisterItemsService.execute({
          ...
          idUserOwner: typeProductExists.idUserOwner ? typeProductExists.idUserOwner : idUserOwner
        });
        return {
          data: {
...
0 && (module.exports = {
  TypeProductsDeleteService
});
//# sourceMappingURL=typeProductsDeleteService.js.map