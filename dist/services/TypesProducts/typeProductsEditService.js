...
// src/services/TypesProducts/typeProductsEditService.ts
var typeProductsEditService_exports = {};
__export(typeProductsEditService_exports, {
  TypeProductsEditService: () => TypeProductsEditService
});
module.exports = __toCommonJS(typeProductsEditService_exports);
...
// src/services/TypesProducts/typeProductsEditService.ts
var TypeProductsEditService = class {
  execute(_0) {
    return __async(this, arguments, function* ({
      ...
      try {
        yield prisma_default.typesProducts.update({
          where: {
            id
          },
          data: {
...
0 && (module.exports = {
  TypeProductsEditService
});
//# sourceMappingURL=typeProductsEditService.js.map