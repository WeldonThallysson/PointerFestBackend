...
// src/services/Commercials/commercialsGetDetailsService.ts
var commercialsGetDetailsService_exports = {};
__export(commercialsGetDetailsService_exports, {
  CommercialGetDetailsService: () => CommercialGetDetailsService
});
module.exports = __toCommonJS(commercialsGetDetailsService_exports);
...
// src/services/Commercials/commercialsGetDetailsService.ts
var CommercialGetDetailsService = class {
  execute(_0) {
    return __async(this, arguments, function* ({ id, idUserOwner }) {
      try {
        ...
        const commercialExists = yield prisma_default.commercials.findFirst({
          where: {
            id,
            idUserOwner
          }
        ...
        if (!commercialExists) {
          return {
            data: {
              message: "N\xE3o foi poss\xEDvel prosseguir com esta a\xE7\xE3o, esse comercial n\xE3o existe",
              status: 404
            }
          };
        }
...
0 && (module.exports = {
  CommercialGetDetailsService
});
//# sourceMappingURL=commercialsGetDetailsService.js.map