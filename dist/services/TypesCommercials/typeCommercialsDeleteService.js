...
// src/services/TypesCommercials/typeCommercialsDeleteService.ts
var typeCommercialsDeleteService_exports = {};
__export(typeCommercialsDeleteService_exports, {
  TypeCommercialsDeleteService: () => TypeCommercialsDeleteService
});
module.exports = __toCommonJS(typeCommercialsDeleteService_exports);
...
// src/services/TypesCommercials/typeCommercialsDeleteService.ts
var TypeCommercialsDeleteService = class {
  execute(_0) {
    return __async(this, arguments, function* ({
      ...
      if (!id) {
        return {
          data: {
            message: "N\xE3o foi poss\xEDvel prosseguir com esta a\xE7\xE3o, por favor envio o id do tipo de comercial para prosseguir",
            status: 403
          }
        };
      }
      ...
      const typeCommercialsExists = yield prisma_default.typesCommercials.findFirst({
        where: {
          id
        }
      });
      if (!typeCommercialsExists) {
        return {
          data: {
            message: "N\xE3o foi poss\xEDvel prosseguir com esta a\xE7\xE3o, este tipo de comercial n\xE3o existe",
            status: 403
          }
        };
      }
...
0 && (module.exports = {
  TypeCommercialsDeleteService
});
//# sourceMappingURL=typeCommercialsDeleteService.js.map